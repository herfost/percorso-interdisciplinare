...
// mysqli_query($connection, "DROP DATABASE " . $DB_NAME);
...
function insert_section($language, $heading, $paragraph, $image_id)
{
   global $connection, $INSERT_SECTIONS_QUERY;
   $query = sprintf($INSERT_SECTIONS_QUERY, $language, $image_id, $heading, $paragraph);
   echo $query;
   return mysqli_query_trace($connection, $query);
}